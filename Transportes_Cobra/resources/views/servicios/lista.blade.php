        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    Lista de operaciones de servicio.
                </div>
                <div class="card-body">
            ...
            //{data: 'estatus', name: 'estatus'},
            {
                render: function (data,type,row){
                    ...
                    if (row.estado == 1) {
                        ...
                        html = '<div class="row">'+
                            '<div class="col-md-12">'+
                            '<a href="{{url("/servicio/atender")}}/'+row.folio+'" class="btn btn-primary btn-block" id="atendersolicitud" name="atendersolicitud" data-id="'+row.folio+'">Atender</a>'+
                            '</div>'+
                           '</div>';   
                    }else{
