                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input tipe="text" class="form-control lg-4" id="descipcion" name="descipcion">
                        </div>
                        <div class="col-md-4">
                            <label for="area">Área:</label>
                            <select class="form-control campo-requerido" id="area" name="area">
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            ...
                            <select class="form-control campo-requerido" id="modulop" name="modulop">
                                <option value="">Seleccione...</option>
                        ...
                        <div class="col-md-5">
                            ...
                            <select multiple class="form-control" name="moduloh" id="moduloh">
                                <option value="">Seleccione...</option>
                            </select>
                        </div>
                        <div class="col-md-1">
